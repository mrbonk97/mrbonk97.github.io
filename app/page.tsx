...
export default function Home() {
  return (
    <>
      <PageTransition />
      <main className="w-full h-full lg:min-h-[750px] text-secondary text-4xl md:text-7xl lg:text-8xl font-extrabold tracking-widest flex flex-col gap-20 items-center justify-center bg-background">
